<template>
  <div class="relative">
    <div @click="toggleCustomRate" :class="checkCustom ? 'border-l-2 border-avalabGreen' : 'hover:bg-gray-50 dark:hover:bg-gray-500'" class="flex items-center justify-center cursor-pointer w-8 h-6 relative hover:bg-gray-50 dark:hover:bg-gray-500 dark:text-gray-300 dark:bg-slightDark bg-slightGray rounded-lg focus:outline-none focus:ring-1 focus:ring-black focus:ring-opacity-20 st5">
    ...
    >
      <div class="absolute z-50 w-48 bottom-0 right-0" v-if="isOpen">
        <div class="relative flex flex-col space-y-2 py-2 st5 border-l-2 border-avalabGreen shadow-lg rounded-lg p-1 px-2 bg-gray-100 dark:bg-slightDark">
