<template>
  ...
  <!-- Approved -->
  <transition tag="div" name="approve-btn" class="inline-block absolute">
    <div v-if="this.getBtnState({approve: 'approved'})" class="flex st5 w-28 justify-between items-center border border-avalabGreen glow-avalabGreen-light-md space-x-1 p-2 pl-3 rounded-full dark:bg-avalabDark-gray bg-gray-100 cursor-default">
      <div class="flex flex-1 items-center justify-center">
