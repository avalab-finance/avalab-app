<template>
  <div class="flex pt-3 st5-all">
    ...
    <div v-if="token('token1', 'token2')" class="flex flex-1 items-center justify-between">
      <!-- Reset Tokens Button -->
      <div @click="this.resetTokens()" class="flex items-center pr-4 rounded-full hover:bg-gray-100 dark:hover:bg-avalabDark-gray bg-opacity-100 hover:bg-opacity-30 cursor-pointer">
      ...
      <div @click="goTo('addremoveliquidity')" class="flex h-9 st5 items-center space-x-2 ss:space-x-0 xs:space-x-2 rounded-full group bg-gray-100 hover:bg-gray-200 dark:bg-avalabDark-gray dark:hover:bg-gray-900 ss:pl-0 xs:pl-3 cursor-pointer">
        <p class="ss:hidden xs:block text-sm text-gray-500 dark:text-avalabBlue-light">next</p>
        <i class="las la-arrow-right text-lg p-2 st5 text-gray-500 dark:text-avalabBlue-light rounded-full bg-gray-100 dark:bg-avalabDark-gray group-hover:bg-avalabGreen dark:group-hover:text-avalabDark-gray group-hover:text-gray-100 border-2 border-gray-200 dark:border-gray-700"></i>
      </div>
    </div>
