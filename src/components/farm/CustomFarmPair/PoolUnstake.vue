    ...
    <div v-if="isOpen" class="flex flex-col justify-between h-full w-full absolute">
      <div class="flex flex-col space-y-2">
        <div class="flex items-center space-x-2 mx-2">
          <i class="las la-hand-holding-usd text-xl text-avalabGreen"></i>
          ...
          <div class="grid grid-cols-2 gap-3 pt-3 pb-3 px-3">
            <div class="flex h-12 space-x-2">
              ...
              <div class="flex flex-col h-full justify-between">
                <p class="text-xs text-avalabBlue-light">LP Tokens Staked</p>
            ...
            <div class="flex items-center justify-end group-scope">
              <div @click="setMax()" class="flex items-center group-scope-hover:bg-avalabGreen text-avalabGreen-dark dark:text-avalabGreen border border-avalabGreen-dark dark:border-avalabGreen cursor-pointer p-3 rounded-xl space-x-2">
                <i class="las la-wallet text-xl dark:group-scope-hover:text-avalabDark-gray group-scope-hover:text-gray-100"></i>
                <p class="dark:group-scope-hover:text-avalabDark-gray group-scope-hover:text-gray-100">MAX</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="flex justify-between items-center mb-0.5 h-9">
        <!-- back to Stats -->
        <div @click="setPool()" class="flex h-9 items-center space-x-2 ss:space-x-0 sm:space-x-2 md:space-x-0 xl:space-x-2 rounded-full group bg-gray-100 hover:bg-gray-200 dark:bg-avalabDark-gray dark:hover:bg-gray-900 pr-3 ss:pr-0 sm:pr-3 md:pr-0 xl:pr-3 cursor-pointer">
          <i class="las la-arrow-left text-lg p-2 text-gray-500 dark:text-avalabBlue-light rounded-full bg-gray-100 dark:bg-avalabDark-gray group-hover:bg-avalabGreen dark:group-hover:text-avalabDark-gray group-hover:text-gray-100 border-2 border-gray-200 dark:border-gray-700"></i>
          <p class="ss:hidden sm:block md:hidden xl:block text-sm text-gray-500 dark:text-avalabBlue-light">back</p>
        </div>
        ...
        <div class="flex items-center w-28 h-full relative">
          ...
          <transition tag="div" name="approve-btn" class="inline-block absolute">
            <div @click="unstake()" v-if="buttonState == 'active'" class="flex w-28 group-scope">
              ...
              <div class="grab-attention cursor-pointer">
                <div class="flex flex-1 items-center justify-center">
                  <p class="text-sm text-avalabGreen-dark dark:text-avalabGreen group-scope-hover:text-gray-50 dark:group-scope-hover:text-avalabDark-gray">Unstake</p>
                </div>
                <i class="las las la-download text-xl text-avalabGreen-dark dark:text-avalabGreen group-scope-hover:text-gray-50 dark:group-scope-hover:text-avalabDark-gray"></i>
              </div>
            </div>
          </transition> 
            ...
            <div v-if="buttonState == 'executing'" class="flex w-28 group-scope">
              ...
              <div class="grab-attention cursor-wait">
                <div class="flex flex-1 items-center justify-right">
                  <p class="text-sm text-avalabGreen-dark dark:text-avalabGreen group-scope-hover:text-gray-50 dark:group-scope-hover:text-avalabDark-gray">Unstaking</p>
                </div>
          ...
          <!-- Unstaked -->
          <transition tag="div" name="approve-btn" class="inline-block absolute">
            <div v-if="buttonState == 'finished'" class="flex w-28 justify-between items-center border border-avalabGreen glow-avalabGreen-light-md space-x-1 p-2 pl-3 rounded-full dark:bg-avalabDark-gray bg-gray-100 cursor-default">
              <div class="flex flex-1 items-center justify-right">
                <p class="text-sm text-avalabGreen">Unstaked</p>
              </div>
