<template>
  <div class="flex flex-col xs:justify-center sm:justify-center ">
  
    <div class="flex space-x-4 items-center mb-6">
      <i class="las la-globe-europe text-lg dark:text-avalabGreen"></i>
      <p class="text-avalabGreen-dark dark:text-avalabBlue-light text-sm uppercase">Total :</p>
    </div>
