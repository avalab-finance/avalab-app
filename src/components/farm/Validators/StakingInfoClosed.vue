<template>
  ...
  <div v-if="validator" class="grid grid-cols-4 grid-rows-1 mb-1 pl-4 py-2 dark:from-slightDark items-center from-slightGray to-transparent dark:hover:bg-slightDark hover:bg-slightGray rounded-lg border-l border-avalabGreen" >
    <div class="text-avalabBlue-light">{{ validator.name }}</div>
    <div class="rounded-md align-middle">
      <div class="flex items-center align-middle space-x-2">
        <i class="las la-layer-group text-avalabGreen text-4xl"></i>
        <div class="flex flex-col">
          <p class="text-sm text-avalabBlue-light">Total Staked:</p>
    ...
    <div class="rounded-md align-middle xs:invisible ss:invisible sm:invisible">
      <div class="flex items-center align-middle space-x-2">
        <i class="las la-percent text-avalabGreen text-4xl"></i>
        <div class="flex flex-col">
