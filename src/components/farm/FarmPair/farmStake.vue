 <template>
    ...
    <div @click="stake()" v-if="buttonState == 'active'" class="flex w-22 group-scope">
      ...
      <div class="grab-attention cursor-pointer">
        <div class="flex items-center justify-center">
          <p class="text-sm ml-5 text-avalabGreen-dark dark:text-avalabGreen group-scope-hover:text-gray-50 dark:group-scope-hover:text-avalabDark-gray">Stake</p>
        </div>
        <i class="las la-upload text-xl pr-5 text-avalabGreen-dark dark:text-avalabGreen group-scope-hover:text-gray-50 dark:group-scope-hover:text-avalabDark-gray"></i>
      </div>
    </div>
  </transition>
  ...
  <transition tag="div" name="swap-btn" class="inline-block absolute">
    <div v-if="buttonState == 'executing'" class="flex w-22 group-scope">
      ...
      <div class="grab-attention cursor-wait">
        <div class="flex flex-1 items-center justify-center">
          <p class="text-sm text-avalabGreen-dark dark:text-avalabGreen group-scope-hover:text-gray-50 dark:group-scope-hover:text-avalabDark-gray">Staking</p>
        </div>
  ...
  <transition tag="div" name="approve-btn" class="inline-block absolute">
    <div v-if="buttonState == 'finished'" class="flex w-28 justify-between items-center border border-avalabGreen glow-avalabGreen-light-md space-x-1 p-2 pl-3 rounded-full cursor-default">
      <div class="flex flex-1 items-center justify-center">
        <p class="text-sm text-avalabGreen">Staked</p>
      </div>
