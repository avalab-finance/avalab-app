<template>
  <div :class="token(whichToken) ? 'border border-avalabGreen' : ''" class="flex h-24 z-10 px-2 rounded-xl ring-1 ring-black dark:ring-gray-600 ring-opacity-10 hover:bg-gray-100 dark:hover:bg-avalabDark-gray bg-opacity-100 hover:bg-opacity-30 cursor-pointer overflow-hidden">
    ...
    <div v-if="!token(whichToken)" class="flex flex-1 items-center space-x-2 justify-center h-full">
      ...
      <i class="las la-angle-down dark:text-gray-300"></i>
    </div>
