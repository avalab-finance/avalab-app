<template>
  <div :class="token(whichToken) ? 'border border-avalabGreen' : 'border border-black border-opacity-10'" class="flex h-24 z-10 px-2 rounded-xl hover:bg-gray-100 dark:hover:bg-avalabDark-gray st5 cursor-pointer overflow-hidden">
