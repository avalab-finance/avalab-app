<template>
  <div class="flex flex-col pb-5 pt-2.5">
    <div class="flex flex-col p-4 st5 bg-gradient-to-l from-slightGray dark:from-slightDark to-transparent ss:w-80 xs:w-96 rounded-3xl border-l border-avalabGreen h-auto">
      ...
      <div class="flex flex-col st5 dark:bg-avalabDark-gray bg-gray-100 rounded-2xl">
        <div class="flex flex-col st5 dark:bg-avalabDark-gray bg-gray-100 rounded-2xl">
          <div class="flex shadow-lg flex-col space-y-3 st5 dark:bg-avalabDark-gray bg-gray-100 p-3 rounded-2xl">
            <SwapperToken0 />
            <SwapperToken1 />
          </div>
          <SwapperReserves />
