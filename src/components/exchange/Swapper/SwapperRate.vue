<template>
  <div class="flex items-center justify-between text-xs min-w-0 px-1 mt-3">
    ...
    <div class="flex items-center ss:space-x-1 xs:space-x-2">
      <div class="flex">
        <div class="flex pr-1 items-center rounded-lg text-avalabGreen">
          <p>{{getSlippageRate}}%</p>
        </div>
      </div>
      <SelectRate rate="0.4" :picked="getSlippageRate" @selectRate="updateSelectedRate" hover="hover:bg-gray-50" darkHover="dark:hover:bg-slightDark" :class="'dark:text-gray-300 dark:bg-avalabDark-gray bg-gray-100'" />
      <SelectRate rate="0.8" :picked="getSlippageRate" @selectRate="updateSelectedRate" hover="hover:bg-gray-50" darkHover="dark:hover:bg-slightDark" :class="'dark:text-gray-300 dark:bg-avalabDark-gray bg-gray-100'" />
      <SelectRate rate="1.2" :picked="getSlippageRate" @selectRate="updateSelectedRate" hover="hover:bg-gray-50" darkHover="dark:hover:bg-slightDark" :class="'dark:text-gray-300 dark:bg-avalabDark-gray bg-gray-100'" />
