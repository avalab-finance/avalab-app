<template>
  <div class="flex pt-3">
    ...
    <div v-if="token('token1', 'token2')" class="flex flex-1 items-center justify-between">
      <!-- Reset Tokens Button -->
      <div @click="this.resetTokens()" class="flex items-center pr-4 rounded-full st5 hover:bg-gray-100 dark:hover:bg-avalabDark-gray bg-opacity-100 hover:bg-opacity-30 cursor-pointer">
      ...
      <div @click="goTo('swapper')" class="flex h-9 st5 items-center space-x-2 ss:space-x-0 xs:space-x-2 rounded-full group bg-gray-100 hover:bg-gray-200 dark:bg-avalabDark-gray dark:hover:bg-gray-900 ss:pl-0 xs:pl-3 cursor-pointer">
