<template>
  <div v-if="token('token1', 'token2')" @click="this.switchTokens()" class="flex items-center justify-center relative z-20 group cursor-pointer">
    <div class="flex absolute items-center justify-center w-7 h-7 rounded-lg glow-avalabBlue-light-lg bg-slightGray dark:bg-slightDark border border-avalabGreen group-hover:bg-avalabGreen st5">
      <i class="las la-exchange-alt text-lg text-avalabGreen group-hover:text-gray-50 st5"></i>
    </div>
  </div>
