<template>  
  ...
  >
    <transition name="fade-in" appear>
      <p v-if="getWalletType != 'metamask' " class="absolute center-y-component left-6 dark:text-gray-400 font-extralight text-sm">Avalanche</p>
    </transition>
    <transition name="fade-in" appear>
    ...
    >
      <transition name="fade-out-and-rotate" appear>
        <img v-if="getWalletType != 'metamask'" src="@/assets/Avalanche.png" alt="" class="h-5">
      </transition>
    ...
    methods: {
      ...
      setWalletType(){
        ...
        if(this.getWalletType == 'oneWallet'){
          ...
          var walletString = 'Avalanche Wallet'
