    ...
    metaInfo: {
      ...
      charset: 'utf-8' ,
       name: 'viewport',
        ...
        title: 'AVALab Exchange',
        description: 'AVALab Decentralized Exchange on Avalanche Blockchain. Avalanche DEX',
        keywords: 'Dex, Decentralised Exchange, DEX, blockchain, Avalanche, AVALab, Uniswap Fork',
        robots: 'index, follow'
