<template>
  <div id="utility" class="max-w-screen-xl mx-auto flex flex-1 flex-col items-center justify-center avalab-layout xl:px-0 px-3 text-gray-500 pb-16 mt-8">
    <transition name="horizontal">
      ...
      <div class="md:w-8/12 mt-6">
        ...
        <div class="grid grid-cols-1 w-full gap-6">
          <OneAddress :oneAddress="oneAddress" :oxAddress="oxAddress" />
          <RevokeAddress />
        </div>
      </div>
    </transition>
