<template>
  <div id="wallet" class="max-w-screen-xl mx-auto flex flex-1 flex-col items-center avalab-layout xl:px-0 px-3 text-gray-500 pb-16">
    <div class="flex flex-col w-full ss:mt-3 ss:mb-6 xs:mt-8 xs:mb-12 text-gray-600 dark:text-gray-200">
      
      <div class="flex items-start space-x-3 mb-8">
        <i class="las la-wallet text-3xl dark:text-avalabGreen text-gray-600"></i>
      ...
      <div class="flex w-full">
        ...
        <div class="flex w-full font-nunito">
          ...
          <WalletAvalanche v-if="btnActive == 'avalanche'" />
        </div>
      </div>
...
<script>
  ...
  import WalletAvalanche from '@/components/wallet/WalletAvalanche'
