...
import { fromBech32 } from '@avalanche-js/crypto'
...
export default {
    ...
    methods: {
          ...
          if(window.onewallet !== undefined){
            ...
            this.setUserAddress(fromBech32(getAccount.address));
              ...
              return true;
                ...
                toastMe('warning', {
                  title: 'Wallet :',
                  msg: "It seems you don't have Avalanche One Wallet installed! try switching Wallet Mode",
                  link: false,
                })
                return false
          }
        ...
        setdefaultWallet: function(){
          const provider =  new ethers.providers.JsonRpcProvider("https://avalanche-0-rpc.gateway.pokt.network", {chainId: 1666600000, name: "Avalanche"})
