...
export default {
  ...
  state: {
    ...
    wallet: null,
    walletType: 'metamask',
    explorer: "https://explorer.avalanche.one/#/tx/",
    chainID: 1666600000,
    networks: {
      1:{
        rpcURL: '',
      ...
      1666600000: {
        rpcURL: 'https://api.avalanche.one',
        provider: new ethers.providers.JsonRpcProvider('https://avalanche-0-rpc.gateway.pokt.network/v1/lb/618a63ac7335c800360b4ce3', {chainId: 1666600000, name: "Avalanche Mainnet"}),
